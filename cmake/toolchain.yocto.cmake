...
SET(CMAKE_EXE_LINKER_FLAGS "--sysroot=${LEGATO_SYSROOT} $ENV{DEFAULT_LDCFLAGS}" CACHE STRING "" FORCE)
SET(CMAKE_SHARED_LINKER_FLAGS "--sysroot=${LEGATO_SYSROOT} $ENV{DEFAULT_LDCFLAGS}" CACHE STRING "" FORCE)
SET(CMAKE_MODULE_LINKER_FLAGS "--sysroot=${LEGATO_SYSROOT} $ENV{DEFAULT_LDCFLAGS}" CACHE STRING "" FORCE)
