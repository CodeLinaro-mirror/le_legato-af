 ...
 * | -----------------------------|-------------------------------------------------------------------------| -------------------------| --------------------------------------------------------------------------------------------------------------------------|
 * | @subpage c_atomic            | @rst :ref:`le_atomic.h <File le_atomic.h>` @endrst                      | @c le_atomic.h           | Provides atomic operations                                                                                                |
 * | @subpage c_args              | @rst :ref:`le_args.h <File le_args.h>` @endrst                          | @c le_args.h             | Provides the ability to add arguments from the command line                                                               |
 * | @subpage c_atomFile          | @rst :ref:`le_atomFile.h <File le_atomFile.h>` @endrst                  | @c le_atomFile.h         | Provides atomic file access mechanism that can be used to perform file operation (specially file write) in atomic fashion |
 * | @subpage c_basics            | @rst :ref:`le_basics.h <File le_basics.h>` @endrst                      | @c le_basics.h           | Provides error codes, portable integer types, and helpful macros that make things easier to use                           |
 * | @subpage c_clock             | @rst :ref:`le_clock.h <File le_clock.h>` @endrst                        | @c le_clock.h            | Gets/sets date and/or time values, and performs conversions between these values.                                         |
 * | @subpage c_crc               | @rst :ref:`le_crc.h <File le_crc.h>` @endrst                            | @c le_crc.h              | Provides the ability to compute the CRC of a binary buffer                                                                |
 * | @subpage c_dir               | @rst :ref:`le_dir.h <File le_dir.h>` @endrst                            | @c le_dir.h              | Provides functions to control directories                                                                                 |
 * | @subpage c_doublyLinkedList  | @rst :ref:`le_doublyLinkedList.h <File le_doublyLinkedList.h>` @endrst  | @c le_doublyLinkedList.h | Provides a data structure that consists of data elements with links to the next node and previous nodes                   |
 * | @subpage c_eventLoop         | @rst :ref:`le_eventLoop.h <File le_eventLoop.h>` @endrst                | @c le_eventLoop.h        | Provides event loop functions to support the event-driven programming model                                               |
 * | @subpage c_fdMonitor         | @rst :ref:`le_fdMonitor.h <File le_fdMonitor.h>` @endrst                | @c le_fdMonitor.h        | Provides monitoring of file descriptors, reporting, and related events                                                    |
 * | @subpage c_flock             | @rst :ref:`le_fileLock.h <File le_fileLock.h>` @endrst                  | @c le_fileLock.h         | Provides file locking, a form of IPC used to synchronize multiple processes' access to common files                       |
 * | @subpage c_fs                | @rst :ref:`le_fs.h <File le_fs.h>` @endrst                              | @c le_fs.h               | Provides a way to access the file system across different platforms                                                       |
 * | @subpage c_hashmap           | @rst :ref:`le_hashmap.h <File le_hashmap.h>` @endrst                    | @c le_hashmap.h          | Provides creating, iterating and tracing functions for a hashmap                                                          |
 * | @subpage c_hex               | @rst :ref:`le_hex.h <File le_hex.h>` @endrst                            | @c le_hex.h              | Provides conversion between Hex and Binary strings                                                                        |
 * | @subpage c_json              | @rst :ref:`le_json.h <File le_json.h>` @endrst                          | @c le_json.h             | Provides fast parsing of a JSON data stream with very little memory required                                              |
 * | @subpage c_logging           | @rst :ref:`le_log.h <File le_log.h>` @endrst                            | @c le_log.h              | Provides a toolkit allowing code to be instrumented with error, warning, informational, and debugging messages            |
 * | @subpage c_memory            | @rst :ref:`le_mem.h <File le_mem.h>` @endrst                            | @c le_mem.h              | Provides functions to create, allocate and release data from a memory pool                                                |
 * | @subpage c_messaging         | @rst :ref:`le_messaging.h <File le_messaging.h>` @endrst                | @c le_messaging.h        | Provides support to low level messaging within Legato                                                                     |
 * | @subpage c_mutex             | @rst :ref:`le_mutex.h <File le_mutex.h>` @endrst                        | @c le_mutex.h            | Provides standard mutex functionality with added diagnostics capabilities                                                 |
 * | @subpage c_pack              | @rst :ref:`le_pack.h <File le_pack.h>` @endrst                          | @c le_pack.h             | Provides low-level pack/unpack functions to support the higher level IPC messaging system                                 |
 * | @subpage c_path              | @rst :ref:`le_path.h <File le_path.h>` @endrst                          | @c le_path.h             | Provides support for UTF-8 null-terminated strings and multi-character separators                                         |
 * | @subpage c_pathIter          | @rst :ref:`le_pathIter.h <File le_pathIter.h>` @endrst                  | @c le_pathIter.h         | Iterate over paths, traverse the path node-by-node, or create and combine paths together                                  |
 * | @subpage c_rand              | @rst :ref:`le_rand.h <File le_rand.h>` @endrst                          | @c le_rand.h             | Used for cryptographic purposes such as encryption keys, initialization vectors, etc.                                     |
 * | @subpage c_safeRef           | @rst :ref:`le_safeRef.h <File le_safeRef.h>` @endrst                    | @c le_safeRef.h          | Protect from damaged or stale references being used by clients                                                            |
 * | @subpage c_semaphore         | @rst :ref:`le_semaphore.h <File le_semaphore.h>` @endrst                | @c le_semaphore.h        | Provides standard semaphore functionality, but with added diagnostic capabilities                                         |
 * | @subpage c_signals           | @rst :ref:`le_signals.h <File le_signals.h>` @endrst                    | @c le_signals.h          | Provides software interrupts for running processes or threads                                                             |
 * | @subpage c_singlyLinkedList  | @rst :ref:`le_singlyLinkedList.h <File le_singlyLinkedList.h>` @endrst  | @c le_singlyLinkedList.h | Provides a data structure consisting of a group of nodes linked together linearly                                         |
 * | @subpage c_test              | @rst :ref:`le_test.h <File le_test.h>` @endrst                          | @c le_test.h             | Provides macros that are used to simplify unit testing                                                                    |
 * | @subpage c_threading         | @rst :ref:`le_thread.h <File le_thread.h>` @endrst                      | @c le_thread.h           | Provides controls for creating, ending and joining threads                                                                |
 * | @subpage c_timer             | @rst :ref:`le_timer.h <File le_timer.h>` @endrst                        | @c le_timer.h            | Provides functions for managing and using timers                                                                          |
 * | @subpage c_tty               | @rst :ref:`le_tty.h <File le_tty.h>` @endrst                            | @c le_tty.h              | Provides routines to configure serial ports                                                                               |
 * | @subpage c_utf8              | @rst :ref:`le_utf8.h <File le_utf8.h>` @endrst                          | @c le_utf8.h             | Provides safe and easy to use string handling functions for null-terminated strings with UTF-8 encoding                   |
 *
